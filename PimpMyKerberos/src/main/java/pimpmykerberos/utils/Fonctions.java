...
public class Fonctions {
	...
	public static void trace(String type, String message, String from) {
		...
		String line = date + " [Thread-" + threadId + "(" + Thread.currentThread().getName() + ")] " + type + " " + from
				+ " - " + message;
	...
	/**
	 * Charge dans son int�gralit� un fichier et place les lignes de celui-ci
	 * dans une ArrayList
	 * 
	...
	public static void traceBanner() {
		Fonctions.trace("INF","  _____ _                 __  __       _  __         _                        ","CORE");
		Fonctions.trace("INF"," |  __ (_)               |  \\/  |     | |/ /        | |                       ","CORE");
		Fonctions.trace("INF"," | |__) | _ __ ___  _ __ | \\  / |_   _| ' / ___ _ __| |__   ___ _ __ ___  ___ ","CORE");
		Fonctions.trace("INF"," |  ___/ | '_ ` _ \\| '_ \\| |\\/| | | | |  < / _ \\ '__| '_ \\ / _ \\ '__/ _ \\/ __|","CORE");
		Fonctions.trace("INF"," | |   | | | | | | | |_) | |  | | |_| | . \\  __/ |  | |_) |  __/ | | (_) \\__ \\","CORE");
		Fonctions.trace("INF"," |_|   |_|_| |_| |_| .__/|_|  |_|\\__, |_|\\_\\___|_|  |_.__/ \\___|_|  \\___/|___/","CORE");
		Fonctions.trace("INF","                   | |            __/ |                                       ","CORE");
		Fonctions.trace("INF","                   |_|           |___/                                        ","CORE");
